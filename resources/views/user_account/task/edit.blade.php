        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="view-task">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="col-md-6 col-sm-12  mt-3">
                            <div class="form-group">
                                ...
                                @if(!$task_attachment->isEmpty())
                                    ...
                                    <p><i class="fas fa-eye" aria-hidden="true"></i>&nbsp;<a href="{{$ta->attachment}}" target="blank">{{$ta->attachment}}</a></p>
                                    @endforeach
                                @else
                        ...
                        <div class="col-md-12 col-sm-12 mt-3">
                            <form action="{{ route('emp_task_comment') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="comment">
                                                <div class="comment-details">
                                                    <div class="comment-author">
                                                        @if ($comment->employee->profile_image)
                                                        ...
                                                        <div class="float-right">{{ $comment->created_at->diffForHumans() }}</div>
                                                    </div>
                                                    ...
                                                    <div class="comment-attachments">
                                                        @foreach ($comment->file as $key => $value)
                                                            ...
                                                            @endphp
                                                             @php
                                                             $fileExtension = pathinfo($value->file, PATHINFO_EXTENSION);
                                                             $isImage = in_array($fileExtension, ['png', 'jpeg', 'jpg']);
                                                         @endphp
                                                  
                                                         <a href="{{ $value->file }}" target="_blank" class="attachment-link mx-2">
                                                             @if ($isImage)
                                                                 <img style="height: 60px" src="{{ $value->file }}" alt="Attachment Image" class="attachment-image">Attachment{{ $key == 0 ? '' : $key }}
                                                             @else
                                                                 <i class="far {{$iconClass}}"></i> Attachment{{ $key == 0 ? '' : $key }}
                                                             @endif
                                                         </a>
                                                        @endforeach
                                                    </div>
                                                ...
                                                <a href="{{ route('emp_task_comment_delete', $comment->id) }}"
                    ...
                    <div role="tabpanel" class="tab-pane in " id="add-task-update">
                        <div class="row clearfix">
