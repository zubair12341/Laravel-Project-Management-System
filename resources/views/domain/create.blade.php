                    ...
                    <div class="header">
                        <div class="d-flex justify-content-center">
                            <div id="margin" class="max-w-50 ">
                                <h1 style="border-bottom: 1px solid white;color:white;font-weight:bold;">Add Domain</h1>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix shadow "
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="domain_service_name" class="form-control show-tick ms"
                                        value="{{ old('domain_service_name') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="service_provider_name" class="form-control show-tick ms"
                                        value="{{ old('service_provider_name') }}" required>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="d-flex">
                                    ...
                                    <div class="form-group">
                                        <input type="checkbox" name="d_exp" id="d_exp" class="show-tick ms mt-3" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" id="domain_renewl_status">
                                ...
                                <div class="form-group">
                                    <input type="text" name="domain_renewl_status" class="form-control show-tick ms"
                                        value="{{ old('domain_renewl_status') }}">
                            ...
                            <div class="col-md-12">
                                <h3 style="font-weight: bold;">cPanel Details</h3>
                                <hr style="margin-top:-15px;">
                            </div>
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <input type="checkbox" id="login1_18" name="" class=" show-tick ms">
                            ...
                            <div class="container mt-3">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary mb-5" id="save-btn">Add
                                        Domain</button>
                                </div>
                            </div>
                        </div>
